...
(function (l) {
    ...
    function Ga(a, b, c) {
        ...
        c !== q && null !== c && (Cb(c), P(u.defaults.column, c, !0), c.mDataProp === q || c.mData || (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), c.sClass && e.addClass(c.sClass), h = b.sClass, l.extend(b, c), X(b, c, "sWidth", "sWidthOrig"), h !== b.sClass && (b.sClass = h + " " + b.sClass), c.iDataSort !== q && (b.aDataSort = [c.iDataSort]),
            X(b, c, "aDataSort"));
        var f = b.mData, g = na(f), k = b.mRender ? na(b.mRender) : null;
        c = function (m) {
    ...
    function bb(a) {
        ...
        for (e = b.length; g < e; g++) {
            ...
            if (!k.sType && k._sManualType) k.sType =
                k._sManualType; else if (!k.sType) {
                var n = 0;
        ...
        for (var h = a.sDom.split(""), f, g, k, m, n, p, t = 0; t < h.length; t++) {
            ...
            if ("<" == g) {
                ...
                if ("'" == m || '"' == m) {
                    ...
                    -1 != n.indexOf(".") ? (m = n.split("."), k.id = m[0].substr(1, m[0].length - 1), k.className = m[1]) : "#" == n.charAt(0) ? k.id = n.substr(1,
                        n.length - 1) : k.className = n;
                    t += p
                }
                e.append(k);
                e = l(k)
            } else if (">" == g) e = e.parent(); else if ("l" == g && d.bPaginate && d.bLengthChange) f = Lb(a); else if ("f" == g && d.bFilter) f = Mb(a); else if ("r" == g && d.bProcessing) f = Nb(a); else if ("t" == g) f = Ob(a); else if ("i" == g && d.bInfo) f = Pb(a); else if ("p" == g && d.bPaginate) f = Qb(a); else if (0 !== u.ext.feature.length) for (k = u.ext.feature, p = 0, m = k.length; p < m; p++) if (g == k[p].cFeature) {
                f = k[p].fnInit(a);
                break
            }
    ...
    function Oa(a, b, c) {
        ...
        m = {
            data: b, success: g, dataType: "json", cache: !1, type: a.sServerMethod, error: function (n, p, t) {
                ...
                -1 === l.inArray(!0, t) && ("parsererror" == p ? da(a, 0, "Invalid JSON response", 1) : 4 === n.readyState && da(a, 0, "Ajax error",
                    7));
                V(a, !1)
            }
        };
    ...
    function Sb(a, b) {
        var c = function (f, g) {
            ...
            d = za(a, b), e = c("sEcho", "draw"), h = c("iTotalRecords", "recordsTotal");
    ...
    function Mb(a) {
        ...
        var m = l("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", h ? jb(k, h) : k).on("mouseup", function (n) {
            setTimeout(function () {
                k.call(m[0], n)
            }, 10)
    ...
    function ya(a,
                b, c) {
        var d = a.oPreviousSearch, e = a.aoPreSearchCols, h = function (g) {
            d.sSearch = g.sSearch;
            d.bRegex = g.bRegex;
            d.bSmart = g.bSmart;
    ...
    function Zb(a) {
        ...
        if (0 !== b.length) {
            var c = a.oLanguage, d = a._iDisplayStart + 1, e = a.fnDisplayEnd(), h = a.fnRecordsTotal(),
                f = a.fnRecordsDisplay(), g = f ? c.sInfo : c.sInfoEmpty;
    ...
    function Ob(a) {
        ...
        n && k.append(l("<div/>", {"class": h.sScrollFoot}).css({
            ...
            border: 0,
            width: d ? d ? K(d) : null : "100%"
        }).append(l("<div/>", {"class": h.sScrollFootInner}).append(m.removeAttr("id").css("margin-left",
    ...
    function Ha(a) {
        ...
        b = b.iBarWidth;
        var h = l(a.nScrollHead), f = h[0].style, g = h.children("div"), k =
            g[0].style, m = g.children("table");
        g = a.nScrollBody;
        var n = l(g), p = g.style, t = l(a.nScrollFoot).children("div"), v = t.children("table"), x = l(a.nTHead),
    ...
    function ab(a) {
        ...
        if (d || !t && !h && !e && g == oa(a) && g == m.length) for (v = 0; v < g; v++) k = ta(a, v), null !== k && (c[k].sWidth = K(m.eq(v).width())); else {
            ...
            "" !== w.sWidthOrig ? K(w.sWidthOrig) : "", w.sWidthOrig && h && l(m[v]).append(l("<div/>").css({
                width: w.sWidthOrig,
                margin: 0,
                padding: 0,
                border: 0,
            ...
            if (a.aoData.length) for (v = 0; v < k.length; v++) t = k[v], w = c[t], l(bc(a, t)).clone(!1).append(w.sContentPadding).appendTo(r);
        ...
        !n && !h || a._reszEvt || (b = function () {
            l(y).on("resize.DT-" + a.sInstance, jb(function () {
                sa(a)
            }))
    ...
    function cc(a, b) {
        for (var c, d = -1, e = -1, h = 0, f = a.aoData.length; h < f; h++) c = T(a, h, b, "display") + "", c = c.replace(Bc, ""), c = c.replace(/&nbsp;/g, " "), c.length > d && (d = c.length, e = h);
        return e
    }
        ...
        if (!a._bLoadingState) {
            var b = {
                ...
                columns: l.map(a.aoColumns, function (c, d) {
                    return {visible: c.bVisible, search: Xb(a.aoPreSearchCols[d])}
                })
            };
            a.oSavedState = b;
    ...
    function Da(a, b) {
        var c = gc.numbers_length, d = Math.floor(c / 2);
    ...
    function jc(a) {
        return function () {
            var b =
                [Ta(this[u.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));
    ...
    var u = function (a, b) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) da(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                    ...
                    Fb(r, g.aoColumnDefs, v, function (I, H) {
                        Ga(r, I, H)
                    });
                    if (aa.length) {
                        var L = function (I, H) {
        ...
        tb = /['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi, Z = function (a) {
            ...
            return Z(a) ? !0 : Z(a) || "string" === typeof a ? wb(a.replace(Va, ""), b, c) ? !0 : null : null
        }, U = function (a, b, c) {
            ...
            if (Array.isArray(b)) for (var c = 0; c < b.length; c++) pc(a, b[c]); else a.push(b);
            return a
        }, qc = function (a, b) {
            b === q && (b = 0);
    ...
    u.util = {
        throttle: function (a, b) {
            ...
            if ("string" !== typeof a || -1 === a.indexOf(".") && -1 === a.indexOf("[") &&
                -1 === a.indexOf("(")) return function (d, e) {
                return d[a]
            };
    ...
    var S = function (a, b, c) {
            a[b] !== q && (a[c] = a[b])
        }, Fa = /\[.*?\]$/, ra = /\(\)$/, na = u.util.get, ha = u.util.set, lb = u.util.escapeRegex, Qa = l("<div>")[0],
        Ac = Qa.textContent !== q, Bc = /<.*?>/g, jb = u.util.throttle, rc = [], N = Array.prototype,
        Ec = function (a) {
    ...
    l.extend(B.prototype, {
        ...
        join: N.join, indexOf: N.indexOf || function (a, b) {
            ...
            return Eb(this, a, b, 0, this.length, 1)
        }, reduceRight: N.reduceRight || function (a, b) {
            return Eb(this, a, b, this.length - 1, -1, -1)
    ...
    z("tables()", function (a) {
        return a !== q && null !== a ? new B(sc(a, this.context)) : this
    });
    z("table()", function (a) {
        a = this.tables(a);
        var b = a.context;
    ...
    var xb = function (a, b, c, d, e) {
        ...
        if ("current" ==
            b) for (f = a._iDisplayStart, a = a.fnDisplayEnd(); f < a; f++) c.push(d[f]); else if ("current" == f || "applied" == f) if ("none" == h) c = e.slice(); else if ("applied" == h) c = d.slice(); else {
            if ("removed" == h) {
                var g = {};
                f = 0;
    ...
    J("rows().ids()", "row().id()", function (a) {
        for (var b = [], c = this.context, d =
            0, e = c.length; d < e; d++) for (var h = 0, f = this[d].length; h < f; h++) {
    ...
    var Gc = function (a, b, c, d) {
        ...
        0 < U(c, "_details").length && (b.on("draw.dt.DT_details",
            ...
            if (a === e) for (d = 0, e = c.length; d < e; d++) c[d]._details && Ab(b, d)
        }))
    };
    ...
    var Ic =
        /^([^:]+):(name|visIdx|visible)$/, wc = function (a, b, c, d, e) {
        c = [];
        d = 0;
        ...
        return xb("column", b, function (f) {
            ...
            if ("function" === typeof f) {
                ...
                return l.map(d, function (p, t) {
                    return f(t, wc(a, t, 0, 0, k), h[t]) ? t : null
                })
            }
    ...
    J("columns().data()", "column().data()", function () {
        return this.iterator("column-rows", wc, 1)
    });
    J("columns().dataSrc()",
    ...
    z("column()", function (a, b) {
        return zb(this.columns(a, b))
    });
    var Kc = function (a, b, c) {
        var d = a.aoData, e = Ya(a, c), h = oc(Ea(d, e, "anCells")), f = l(pc([], h)), g, k = a.aoColumns.length, m, n,
            p, t, v, x;
    ...
    z("destroy()", function (a) {
        a = a || !1;
        return this.iterator("table", function (b) {
            var c = b.oClasses, d = b.nTable, e = b.nTBody, h = b.nTHead, f = b.nTFoot, g = l(d);
            e = l(e);
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Отобразить _MENU_ записи",
    ...
    l.extend(u.ext.type.detect, [function (a, b) {
        ...
        return null !== b && !isNaN(b) || Z(a) ? "date" : null
                 ...
                 b) {
        b = b.oLanguage.sDecimal;
        return wb(a, b, !0) ? "num-fmt" + b : null
    }, function (a, b) {
        b = b.oLanguage.sDecimal;
        return nc(a, b) ? "html-num" + b : null
    }, function (a, b) {
        b = b.oLanguage.sDecimal;
        return nc(a, b, !0) ? "html-num-fmt" + b : null
    }, function (a, b) {
        return Z(a) || "string" === typeof a && -1 !== a.indexOf("<") ? "html" : null
    }]);
    l.extend(u.ext.type.search, {
        html: function (a) {
            return Z(a) ? a : "string" === typeof a ? a.replace(kc, " ").replace(Va, "") : ""
        }, string: function (a) {
            return Z(a) ? a : "string" === typeof a ? a.replace(kc, " ") : a
        }
    });
    var Ua = function (a,
                       b, c, d) {
