...
(function (e) {
    ...
    var y = !1, C = !1, J = 5E3, K = 2E3, x = 0, F = ["ms", "moz", "webkit", "o"],
        s = window.requestAnimationFrame || !1, v = window.cancelAnimationFrame || !1;
    if (!s) for (var L in F) {
        var D = F[L];
    ...
    var z = window.MutationObserver || window.WebKitMutationObserver || !1, G = {
                            ...
                            if (!a.locked) {
                                ...
                                if (a.ispage || !a.opt.directionlockdeadzone) a.rail.drag.dl = "f"; else {
                                    var f = e(window).width(), n = e(window).height(),
                                        ...
                                        n = Math.max(0, k - n), f = Math.max(0, h - f);
                        ...
                        a.ontouchmove =
                            function (c, b) {
                                ...
                                if (a.rail.drag && 2 == a.rail.drag.pt) {
                                    ...
                                    var h = c.clientY + ofy, n = h - a.rail.drag.y, k = c.clientX + f,
                                        u = k - a.rail.drag.x, g = a.rail.drag.st - n;
        ...
        this.onResize = function (c, b) {
            ...
            0 == a.page.maxh ? (a.hideRail(), a.scrollvaluemax = 0, a.scroll.y = 0, a.scrollratio.y = 0, a.cursorheight = 0, a.setScrollTop(0), a.rail.scrollable = !1) : a.rail.scrollable =
                !0;
